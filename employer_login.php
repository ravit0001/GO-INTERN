      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-login">
          <div class="panel-heading">
            <div class="row">
              <div class="col-xs-12">
                <a href="employer_login.php" class="active" id="login-form-link">Employer Login</a>
              </div>
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-lg-12">
                <form id="login-form" action="employer_login.php" method="get" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <a href="employer_register.php" id="register-submit" tabindex="4" class="form-control btn btn-register">Don't have Account</a>
                        </div>
                    </div>
                  </div>
                </form>
